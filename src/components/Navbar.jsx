    ...
    <nav className="flex justify-between items-center w-9/12 mx-auto">
      ...
      <div className="space-x-5 flex items-center">
        <ul className="space-x-5 sm:flex hidden">
          <li className="hover:bg-[#22d4fc]"><a href="/">How it works?</a></li>
          <li className="hover:bg-[#22d4fc]"><a href="/">Features</a></li>
          <li className="hover:bg-[#22d4fc]"><a href="https://github.com/basavagithubin">My Github</a></li>
